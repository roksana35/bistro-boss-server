  ...
  try {
    ...
    app.post('/jwt',async(req,res)=>{
     ...
     app.post('/menu',async(req,res)=>{
      ...
      const result=await menuCollection.insertOne(quary);
      res.send(result)
     })
    ...
    app.patch('/menus/:id',verifiedToken,verifyAdmin, async (req, res) => {
      const item = req.body;
      const id = req.params.id;
      const filter = { _id: new ObjectId(id) }
      const updatedDoc = {
    ...
    app.delete('/menu/:id',verifiedToken,verifyAdmin, async (req, res) => {
      const id = req.params.id;
      const query = { _id: id }
    ...
    app.get('/payment/:email',verifiedToken,async(req,res)=>{
